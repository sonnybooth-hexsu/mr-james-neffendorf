...
import epiretinalMembrane from '../../static/leaflets/Epiretinal-Membrane-Patient-Information-Leaflet-Nov-25.pdf'
...
import cataracts from '../../static/leaflets/Cataract-Patient-Information-Leaflet-Nov-25.pdf'
...
class PatientHub extends React.Component {
  ...
  render() {
    return (
      <Layout>
        <Seo
          title="Patient Hub | Resources & Support | Mr James Neffendorf"
          description="Explore helpful patient resources, treatment guidance, and support information from Mr James Neffendorf, London's trusted expert in ophthalmic care."
        />
        {/* Hero */}
