        ...
        <section className="px-[5%] bg-white pt-16 md:pt-24 lg:pt-28">
          <div className="container">
            <div className="grid grid-cols-1 gap-x-20 gap-y-12 md:gap-y-16 lg:grid-cols-2 lg:items-center">
              <div>
                <p className="mb-2 overlined category">TREATMENT</p>
                <h1 className="mb-2 font-bold">{post.heading}</h1>
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:pr-8 md:w-2/3">
              <section>
                ...
                <p className="mb-8">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Volutpat a, aliquet massa ullamcorper sagittis, fusce. Ac in
                  risus lectus felis, lectus. Tellus egestas venenatis euismod
                  nunc id praesent enim pretium pellentesque.
                </p>
            ...
            <div className="p-8 rounded-lg shadow-md md:w-1/3 bg-gray-50">
              <h3 className="mb-4 text-2xl font-semibold">
                Enquire about [treatment/condition]
              </h3>
              <form>
                <div className="mb-4">
                  <label
